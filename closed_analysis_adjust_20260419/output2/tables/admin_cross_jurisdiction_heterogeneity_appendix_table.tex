...
\midrule
Treatment $\times$ Post & 0.036$^{***}$ & 0.036$^{***}$ & 0.040$^{***}$ & 0.016$^{**}$ \\
& (0.005) & (0.009) & (0.005) & (0.007) \\
\addlinespace
Coefficient equality test ($p$) & \multicolumn{2}{c}{0.945} & \multicolumn{2}{c}{0.005} \\
\addlinespace
Pre-treatment government win rate & 0.729 & 0.694 & 0.722 & 0.716 \\
Observations & 506,088 & 153,083 & 556,217 & 102,954 \\
$R^2$ & 0.041 & 0.038 & 0.043 & 0.059 \\
